...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('hhttps://sendit-app-two.vercel.app/admin/dashboard');
    ...
    const updateOrderStatus = async (userId, orderId, newStatus) => {
        try {
            await axios.post(`https://sendit-app-two.vercel.app/admin/updateOrderStatus/:orderId`, {
                status: newStatus
            });
            console.log(userId);;
            console.log(orderId);
